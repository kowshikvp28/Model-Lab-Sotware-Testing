...
public class AppTest {
    ...
    public static void startTest() {
        ExtentSparkReporter spark = new ExtentSparkReporter(
                "F:\\modal lab softtest\\modellab\\src\\report\\report.html");
    ...
    public void testCase() throws Exception {
        ...
        FileInputStream fi = new FileInputStream("F:\\modal lab softtest\\modellab\\src\\excel\\Inputs.xlsx");
        // XSSFWorkbook wb = new XSSFWorkbook(fi);
        // XSSFSheet sheet = wb.getSheet("Sheet1");

        // String firstname = sheet.getRow(0).getCell(0).getStringCellValue();
        // String lastname = sheet.getRow(1).getCell(0).getStringCellValue();
        ...
        driver.findElement(By.xpath("//*[@id=\"personalAddress\"]")).sendKeys("22");
        Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id=\"personalCity\"]")).sendKeys("Banglore");
        Thread.sleep(3000);
        ...
        driver.findElement(By.xpath("//*[@id=\"personalEmail\"]")).sendKeys("email@gmail.com");
        Thread.sleep(3000);
        ...
        // String path = "F:\\modal lab softtest\\modellab\\src\\excel\\screenshot.png";
